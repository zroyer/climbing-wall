...
function App() {
  return (
    <div className='App'>
      ...
      >
        A safe place to play with <a href='https://github.com/zroyer/react-carabiner' target='_blank' rel='noopener noreferrer'>react-carabiner</a>, a React Hook to copy to the clipboard!
      </div>
      <div>
        <a
          className='badge'
